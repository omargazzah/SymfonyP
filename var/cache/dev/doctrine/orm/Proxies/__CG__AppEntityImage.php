...
class Image extends \App\Entity\Image implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Image' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Image' . "\0" . 'url', '' . "\0" . 'App\\Entity\\Image' . "\0" . 'alt', '' . "\0" . 'App\\Entity\\Image' . "\0" . 'produit'];
        }
     ...
     * {@inheritDoc}
     */
    public function setProduit(?\App\Entity\Produit $produit): \App\Entity\Image
    {
