...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    protected function getProfilerControllerService()
    {
        ...
        return $this->services['Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController'] = new \Doctrine\Bundle\DoctrineBundle\Controller\ProfilerController(($this->services['twig'] ?? null), ($this->services['doctrine'] ?? $this->getDoctrineService()), ($this->services['profiler'] ?? null));
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('1XuSpzEWQg', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('nc6B9INOM5', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('xfnfbNVP72', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('65PNEPGm97', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('SRsqifxzX7', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('lKXzlFFkpk', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('cITJqj4ubV', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolder5d03f = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializerddee0 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicPropertiese02d8 = [
        
    ];

    public function getConnection()
    {
        $this->initializerddee0 && ($this->initializerddee0->__invoke($valueHolder5d03f, $this, 'getConnection', array(), $this->initializerddee0) || 1) && $this->valueHolder5d03f = $valueHolder5d03f;

        return $this->valueHolder5d03f->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializerddee0 && ($this->initializerddee0->__invoke($valueHolder5d03f, $this, 'getMetadataFactory', array(), $this->initializerddee0) || 1) && $this->valueHolder5d03f = $valueHolder5d03f;

        return $this->valueHolder5d03f->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializerddee0 && ($this->initializerddee0->__invoke($valueHolder5d03f, $this, 'getExpressionBuilder', array(), $this->initializerddee0) || 1) && $this->valueHolder5d03f = $valueHolder5d03f;

        return $this->valueHolder5d03f->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializerddee0 && ($this->initializerddee0->__invoke($valueHolder5d03f, $this, 'beginTransaction', array(), $this->initializerddee0) || 1) && $this->valueHolder5d03f = $valueHolder5d03f;

        return $this->valueHolder5d03f->beginTransaction();
    }

    public function getCache()
    {
        $this->initializerddee0 && ($this->initializerddee0->__invoke($valueHolder5d03f, $this, 'getCache', array(), $this->initializerddee0) || 1) && $this->valueHolder5d03f = $valueHolder5d03f;

        return $this->valueHolder5d03f->getCache();
    }

    public function transactional($func)
    {
        $this->initializerddee0 && ($this->initializerddee0->__invoke($valueHolder5d03f, $this, 'transactional', array('func' => $func), $this->initializerddee0) || 1) && $this->valueHolder5d03f = $valueHolder5d03f;

        return $this->valueHolder5d03f->transactional($func);
    }

    public function wrapInTransaction(callable $func)
    {
        $this->initializerddee0 && ($this->initializerddee0->__invoke($valueHolder5d03f, $this, 'wrapInTransaction', array('func' => $func), $this->initializerddee0) || 1) && $this->valueHolder5d03f = $valueHolder5d03f;

        return $this->valueHolder5d03f->wrapInTransaction($func);
    }

    public function commit()
    {
        $this->initializerddee0 && ($this->initializerddee0->__invoke($valueHolder5d03f, $this, 'commit', array(), $this->initializerddee0) || 1) && $this->valueHolder5d03f = $valueHolder5d03f;

        return $this->valueHolder5d03f->commit();
    }

    public function rollback()
    {
        $this->initializerddee0 && ($this->initializerddee0->__invoke($valueHolder5d03f, $this, 'rollback', array(), $this->initializerddee0) || 1) && $this->valueHolder5d03f = $valueHolder5d03f;

        return $this->valueHolder5d03f->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializerddee0 && ($this->initializerddee0->__invoke($valueHolder5d03f, $this, 'getClassMetadata', array('className' => $className), $this->initializerddee0) || 1) && $this->valueHolder5d03f = $valueHolder5d03f;

        return $this->valueHolder5d03f->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializerddee0 && ($this->initializerddee0->__invoke($valueHolder5d03f, $this, 'createQuery', array('dql' => $dql), $this->initializerddee0) || 1) && $this->valueHolder5d03f = $valueHolder5d03f;

        return $this->valueHolder5d03f->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializerddee0 && ($this->initializerddee0->__invoke($valueHolder5d03f, $this, 'createNamedQuery', array('name' => $name), $this->initializerddee0) || 1) && $this->valueHolder5d03f = $valueHolder5d03f;

        return $this->valueHolder5d03f->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializerddee0 && ($this->initializerddee0->__invoke($valueHolder5d03f, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializerddee0) || 1) && $this->valueHolder5d03f = $valueHolder5d03f;

        return $this->valueHolder5d03f->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializerddee0 && ($this->initializerddee0->__invoke($valueHolder5d03f, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializerddee0) || 1) && $this->valueHolder5d03f = $valueHolder5d03f;

        return $this->valueHolder5d03f->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializerddee0 && ($this->initializerddee0->__invoke($valueHolder5d03f, $this, 'createQueryBuilder', array(), $this->initializerddee0) || 1) && $this->valueHolder5d03f = $valueHolder5d03f;

        return $this->valueHolder5d03f->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializerddee0 && ($this->initializerddee0->__invoke($valueHolder5d03f, $this, 'flush', array('entity' => $entity), $this->initializerddee0) || 1) && $this->valueHolder5d03f = $valueHolder5d03f;

        return $this->valueHolder5d03f->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializerddee0 && ($this->initializerddee0->__invoke($valueHolder5d03f, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializerddee0) || 1) && $this->valueHolder5d03f = $valueHolder5d03f;

        return $this->valueHolder5d03f->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializerddee0 && ($this->initializerddee0->__invoke($valueHolder5d03f, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializerddee0) || 1) && $this->valueHolder5d03f = $valueHolder5d03f;

        return $this->valueHolder5d03f->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializerddee0 && ($this->initializerddee0->__invoke($valueHolder5d03f, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializerddee0) || 1) && $this->valueHolder5d03f = $valueHolder5d03f;

        return $this->valueHolder5d03f->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializerddee0 && ($this->initializerddee0->__invoke($valueHolder5d03f, $this, 'clear', array('entityName' => $entityName), $this->initializerddee0) || 1) && $this->valueHolder5d03f = $valueHolder5d03f;

        return $this->valueHolder5d03f->clear($entityName);
    }

    public function close()
    {
        $this->initializerddee0 && ($this->initializerddee0->__invoke($valueHolder5d03f, $this, 'close', array(), $this->initializerddee0) || 1) && $this->valueHolder5d03f = $valueHolder5d03f;

        return $this->valueHolder5d03f->close();
    }

    public function persist($entity)
    {
        $this->initializerddee0 && ($this->initializerddee0->__invoke($valueHolder5d03f, $this, 'persist', array('entity' => $entity), $this->initializerddee0) || 1) && $this->valueHolder5d03f = $valueHolder5d03f;

        return $this->valueHolder5d03f->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializerddee0 && ($this->initializerddee0->__invoke($valueHolder5d03f, $this, 'remove', array('entity' => $entity), $this->initializerddee0) || 1) && $this->valueHolder5d03f = $valueHolder5d03f;

        return $this->valueHolder5d03f->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializerddee0 && ($this->initializerddee0->__invoke($valueHolder5d03f, $this, 'refresh', array('entity' => $entity), $this->initializerddee0) || 1) && $this->valueHolder5d03f = $valueHolder5d03f;

        return $this->valueHolder5d03f->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializerddee0 && ($this->initializerddee0->__invoke($valueHolder5d03f, $this, 'detach', array('entity' => $entity), $this->initializerddee0) || 1) && $this->valueHolder5d03f = $valueHolder5d03f;

        return $this->valueHolder5d03f->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializerddee0 && ($this->initializerddee0->__invoke($valueHolder5d03f, $this, 'merge', array('entity' => $entity), $this->initializerddee0) || 1) && $this->valueHolder5d03f = $valueHolder5d03f;

        return $this->valueHolder5d03f->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializerddee0 && ($this->initializerddee0->__invoke($valueHolder5d03f, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializerddee0) || 1) && $this->valueHolder5d03f = $valueHolder5d03f;

        return $this->valueHolder5d03f->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializerddee0 && ($this->initializerddee0->__invoke($valueHolder5d03f, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializerddee0) || 1) && $this->valueHolder5d03f = $valueHolder5d03f;

        return $this->valueHolder5d03f->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializerddee0 && ($this->initializerddee0->__invoke($valueHolder5d03f, $this, 'getRepository', array('entityName' => $entityName), $this->initializerddee0) || 1) && $this->valueHolder5d03f = $valueHolder5d03f;

        return $this->valueHolder5d03f->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializerddee0 && ($this->initializerddee0->__invoke($valueHolder5d03f, $this, 'contains', array('entity' => $entity), $this->initializerddee0) || 1) && $this->valueHolder5d03f = $valueHolder5d03f;

        return $this->valueHolder5d03f->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializerddee0 && ($this->initializerddee0->__invoke($valueHolder5d03f, $this, 'getEventManager', array(), $this->initializerddee0) || 1) && $this->valueHolder5d03f = $valueHolder5d03f;

        return $this->valueHolder5d03f->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializerddee0 && ($this->initializerddee0->__invoke($valueHolder5d03f, $this, 'getConfiguration', array(), $this->initializerddee0) || 1) && $this->valueHolder5d03f = $valueHolder5d03f;

        return $this->valueHolder5d03f->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializerddee0 && ($this->initializerddee0->__invoke($valueHolder5d03f, $this, 'isOpen', array(), $this->initializerddee0) || 1) && $this->valueHolder5d03f = $valueHolder5d03f;

        return $this->valueHolder5d03f->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializerddee0 && ($this->initializerddee0->__invoke($valueHolder5d03f, $this, 'getUnitOfWork', array(), $this->initializerddee0) || 1) && $this->valueHolder5d03f = $valueHolder5d03f;

        return $this->valueHolder5d03f->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializerddee0 && ($this->initializerddee0->__invoke($valueHolder5d03f, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializerddee0) || 1) && $this->valueHolder5d03f = $valueHolder5d03f;

        return $this->valueHolder5d03f->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializerddee0 && ($this->initializerddee0->__invoke($valueHolder5d03f, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializerddee0) || 1) && $this->valueHolder5d03f = $valueHolder5d03f;

        return $this->valueHolder5d03f->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializerddee0 && ($this->initializerddee0->__invoke($valueHolder5d03f, $this, 'getProxyFactory', array(), $this->initializerddee0) || 1) && $this->valueHolder5d03f = $valueHolder5d03f;

        return $this->valueHolder5d03f->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializerddee0 && ($this->initializerddee0->__invoke($valueHolder5d03f, $this, 'initializeObject', array('obj' => $obj), $this->initializerddee0) || 1) && $this->valueHolder5d03f = $valueHolder5d03f;

        return $this->valueHolder5d03f->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializerddee0 && ($this->initializerddee0->__invoke($valueHolder5d03f, $this, 'getFilters', array(), $this->initializerddee0) || 1) && $this->valueHolder5d03f = $valueHolder5d03f;

        return $this->valueHolder5d03f->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializerddee0 && ($this->initializerddee0->__invoke($valueHolder5d03f, $this, 'isFiltersStateClean', array(), $this->initializerddee0) || 1) && $this->valueHolder5d03f = $valueHolder5d03f;

        return $this->valueHolder5d03f->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializerddee0 && ($this->initializerddee0->__invoke($valueHolder5d03f, $this, 'hasFilters', array(), $this->initializerddee0) || 1) && $this->valueHolder5d03f = $valueHolder5d03f;

        return $this->valueHolder5d03f->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializerddee0 = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolder5d03f) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolder5d03f = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolder5d03f->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializerddee0 && ($this->initializerddee0->__invoke($valueHolder5d03f, $this, '__get', ['name' => $name], $this->initializerddee0) || 1) && $this->valueHolder5d03f = $valueHolder5d03f;

        if (isset(self::$publicPropertiese02d8[$name])) {
            return $this->valueHolder5d03f->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5d03f;
    ...
    {
        $this->initializerddee0 && ($this->initializerddee0->__invoke($valueHolder5d03f, $this, '__set', array('name' => $name, 'value' => $value), $this->initializerddee0) || 1) && $this->valueHolder5d03f = $valueHolder5d03f;
    ...
    {
        $this->initializerddee0 && ($this->initializerddee0->__invoke($valueHolder5d03f, $this, '__isset', array('name' => $name), $this->initializerddee0) || 1) && $this->valueHolder5d03f = $valueHolder5d03f;
    ...
    {
        $this->initializerddee0 && ($this->initializerddee0->__invoke($valueHolder5d03f, $this, '__unset', array('name' => $name), $this->initializerddee0) || 1) && $this->valueHolder5d03f = $valueHolder5d03f;
    ...
    {
        $this->initializerddee0 && ($this->initializerddee0->__invoke($valueHolder5d03f, $this, '__clone', array(), $this->initializerddee0) || 1) && $this->valueHolder5d03f = $valueHolder5d03f;

        $this->valueHolder5d03f = clone $this->valueHolder5d03f;
    }

    public function __sleep()
    {
        $this->initializerddee0 && ($this->initializerddee0->__invoke($valueHolder5d03f, $this, '__sleep', array(), $this->initializerddee0) || 1) && $this->valueHolder5d03f = $valueHolder5d03f;

        return array('valueHolder5d03f');
    }
    ...
    {
        $this->initializerddee0 = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializerddee0;
    }

    public function initializeProxy() : bool
    {
        return $this->initializerddee0 && ($this->initializerddee0->__invoke($valueHolder5d03f, $this, 'initializeProxy', array(), $this->initializerddee0) || 1) && $this->valueHolder5d03f = $valueHolder5d03f;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder5d03f;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder5d03f;
    }
}
